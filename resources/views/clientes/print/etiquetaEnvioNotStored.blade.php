    ...
    <section class="sheet padding-5mm">
      <div class="sheet-content">
        <div class="position-relative" style="height: 95mm;">
          ...
          <div class="position-absolute bottom-0 end-0 text-label me-5 mb-5 w-50">
            {{ $cliente->shipping_saudacao }}
            <br>
            {{ $cliente->shipping_name }}
            <br>
            {{ $cliente->shipping_address }}
            <br>
            {{ $cliente->shipping_zip}} {{ $cliente->shipping_city}} {{ $cliente->shipping_state}}
            <br>
            {{ $cliente->shipping_country}}
            </>
          </div>
        </div>
    </section>
